use utf8;
package MuScope::Schema::Result::SampleFile;
...
Related object: L<MuScope::Schema::Result::SampleFileType>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BODPa5klgpE1qc+3NlRZvg
